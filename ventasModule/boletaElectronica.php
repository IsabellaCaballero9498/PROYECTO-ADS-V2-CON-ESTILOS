...
<div class="container">
	...
	<nav class='navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0'>
		<a class='navbar-brand col-sm-3 col-md-2 mr-0' href='../securityModule/getUsuario.php'>Empresa DIBRUESMA</a>
			...
			<div class="col-12 my-3 content-boleta bgc-color-boleta " >
				<div class="row">
					...
					<div class="col-4 text-center d-flex justify-content-center align-items-center" style="border: 1px solid red">
						<h4 class="text-uppercase text-danger">Boleta Venta Electronica <br> BX01-00012</h4>
					</div>
